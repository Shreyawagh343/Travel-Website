                ...
                <div className="dark:bg-slate-900 dark:text-white ">
                    <div className=' md:mt-10 mt-0 md:pt-5 pt-10 md:ml-[32rem] ml-[1rem] h-[45rem] md:w-[30rem] w-11/12 flex flex-col md:border border-0 p-5'>
                        ...
                        <form className='flex flex-col pl-7 mt-10' onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <input type="text" name='fullname' className='border border-gray-300 h-10 mt-3 w-11/12 pl-5 rounded-md'{...register("fullname", { required: { value: true, message: "This field is required" }, minLength: { value: 3, message: "name must have letters between 3 and 25" }, maxLength: { value: 25, message: "name must have letters between 3 and 25" } })} />
                            {errors.fullname && <span className='text-red-600 text-xs pt-3'>{errors.fullname.message}</span>}
